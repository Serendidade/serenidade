...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.execute = function (_a) {
        var google_id = _a.google_id, password = _a.password;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, usersRepository.findOne({ where: { google_id: google_id } })];
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new Error_1.default('Google SignIn Error', 401);
                        }
